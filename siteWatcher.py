...
# Original program: https: //github.com/sanbornm/Site-Monitor
# Edited by: Dhiren Audich
...
#This function sets up the mail server connection and returns a funtion
#that accepts a message which is then sent according to the connection.
...
#Check if the site returns a 200 OK status
...
#This function compares the site's current status with the status that it
#previously was. It sends an email iff the status changed.
...
#This function check if there is a working internet connection. It uses
#google and yahoo for this.
...
#This functions attempts to load the old pickle data
...
#Storing the latest data in the pickle file
...
#Reading site entries from an external file
